...
client.on('message', msg => {
 ...
 help.setAuthor(client.botowner.username, message.guild.iconURL());
 help.setDescription("List of commands availible");
 help.setColor(0x00AE86);
...
client.on("message", message => {
  ...
  if (message.guild) {
    ...
    if (client.points.get(key, "level") < curLevel) {
      message.reply(`You've leveled up to level **${curLevel}**! Try getting a life?`);
